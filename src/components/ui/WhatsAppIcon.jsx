/**
 * WhatsApp brand glyph. lucide-react dropped its brand icons, so the CTAs used a
 * generic chat bubble (MessageCircle); this is the real WhatsApp mark. Filled
 * with currentColor, so colour is set via `className` (e.g. text-[#25D366]).
 * API mirrors a lucide icon: `size` + `className`.
 */
