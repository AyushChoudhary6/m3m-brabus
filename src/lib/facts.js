...
export const PROJECT_FACTS = [
  {
    key: "location",
    label: "Location",
    labelKey: "data.fact.location.label",
    value: "Sector 58, Golf Course Extension Road, Gurugram",
    valueKey: "data.fact.location.value",
    icon: "MapPin",
  },
  {
    key: "configs",
    label: "Apartment Types",
    labelKey: "data.fact.configs.label",
    value: "4 & 5 BHK Residences",
    valueKey: "data.fact.configs.value",
    icon: "BedDouble",
  },
  {
    key: "sizes",
    label: "Sizes",
    labelKey: "data.fact.sizes.label",
    value: "≈ 5,000 – 7,000 sq.ft",
    icon: "Maximize2",
    note: "Total area as published. Carpet areas are shared on request.",
    noteKey: "data.fact.sizes.note",
  },
  {
    key: "clubhouse",
    label: "Clubhouse",
    labelKey: "data.fact.clubhouse.label",
    value: "Grand clubhouse with fully equipped gym",
    valueKey: "data.fact.clubhouse.value",
    icon: "Sparkles",
  },
  {
    key: "landArea",
    label: "Land Area",
    labelKey: "data.fact.landArea.label",
    value: null,
    icon: "LandPlot",
    cta: "Request details",
    ctaKey: "data.fact.landArea.cta",
  },
  {
    key: "towers",
    label: "Towers",
    labelKey: "data.fact.towers.label",
    value: null,
    icon: "Building2",
    cta: "Request details",
    ctaKey: "data.fact.towers.cta",
  },
  {
    key: "floors",
    label: "Floors",
    labelKey: "data.fact.floors.label",
    value: null,
    icon: "Layers",
    cta: "Request details",
    ctaKey: "data.fact.floors.cta",
  },
  {
    key: "openSpace",
    label: "Open Space",
    labelKey: "data.fact.openSpace.label",
    value: null,
    icon: "Trees",
    cta: "Request details",
    ctaKey: "data.fact.openSpace.cta",
  },
  {
    key: "possession",
    label: "Possession",
    labelKey: "data.fact.possession.label",
    value: null,
    icon: "CalendarClock",
    cta: "Get possession update",
    ctaKey: "data.fact.possession.cta",
    note: 'The official listing states only that possession is "expected in the coming years".',
    noteKey: "data.fact.possession.note",
  },
  {
    key: "rera",
    label: "RERA Status",
    labelKey: "data.fact.rera.label",
    value: null,
    icon: "ShieldCheck",
    cta: "Get RERA status",
    ctaKey: "data.fact.rera.cta",
    note: "No RERA registration number is published on the official listing yet.",
    noteKey: "data.fact.rera.note",
  },
];
