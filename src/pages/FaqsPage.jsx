...
/* ============================================================
   ...
   `q`/`a` remain in English: they feed the FAQPage JSON-LD and the stable
   DOM anchor slug. `qKey`/`aKey` carry the visible, translatable copy.
   ============================================================ */

const CATEGORIES = [
  { id: "about", label: "About the Project", labelKey: "faqs.catAbout" },
  { id: "configurations", label: "Configurations & Floor Plans", labelKey: "faqs.catConfig" },
  { id: "price", label: "Price & Payment", labelKey: "faqs.catPrice" },
  { id: "location", label: "Location & Connectivity", labelKey: "faqs.catLocation" },
  { id: "amenities", label: "Amenities", labelKey: "faqs.catAmenities" },
  { id: "legal", label: "Legal, RERA & Possession", labelKey: "faqs.catLegal" },
  { id: "buying", label: "Buying Process & NRI", labelKey: "faqs.catBuying" },
];
...
const BANK = [
  ...
  },
  {
    ...
    cta: { kind: "brochure", label: "Request the specification schedule", labelKey: "faqs.cta_about2", subject: "FAQ · Specification" },
  },
  {
    category: "about",
    qKey: "faqs.q_about3",
    ...
    cta: { kind: "enquiry", label: "Ask for the built-form details", labelKey: "faqs.cta_about3", subject: "FAQ · Towers & floors" },
  },
  {
    category: "about",
    qKey: "faqs.q_about4",
    ...
    cta: { kind: "enquiry", label: "Ask for the site details", labelKey: "faqs.cta_about4", subject: "FAQ · Land area" },
  },
  ...
  },
  {
    ...
    cta: { kind: "enquiry", label: "Ask for the carpet areas", labelKey: "faqs.cta_config3", subject: "FAQ · Carpet area" },
  },
  {
    category: "configurations",
    qKey: "faqs.q_config4",
    ...
    cta: { kind: "brochure", label: "Request the floor plans", labelKey: "faqs.cta_config4", subject: "FAQ · Floor plans" },
  },
  ...
  // ---------- Price & Payment ----------
  {
    ...
    cta: { kind: "enquiry", label: "Request the price sheet", labelKey: "faqs.cta_price1", subject: "FAQ · Price" },
  },
  {
    category: "price",
    qKey: "faqs.q_price2",
  ...
  },
  {
    ...
    cta: { kind: "enquiry", label: "Be sent the payment plan first", labelKey: "faqs.cta_price3", subject: "FAQ · Payment plan" },
  },
  {
    category: "price",
    qKey: "faqs.q_price4",
  ...
  },
  {
    ...
    cta: { kind: "visit", label: "Book a site visit", labelKey: "faqs.cta_loc2", subject: "FAQ · Site visit" },
  },
  {
    category: "location",
    qKey: "faqs.q_loc3",
  ...
  },
  {
    ...
    cta: { kind: "visit", label: "Arrange a visit", labelKey: "faqs.cta_loc4", subject: "FAQ · Location visit" },
  },
  ...
  },
  {
    ...
    cta: { kind: "enquiry", label: "Ask about the clubhouse", labelKey: "faqs.cta_amen2", subject: "FAQ · Clubhouse" },
  },
  {
    category: "amenities",
    qKey: "faqs.q_amen3",
  ...
  },
  {
    ...
    cta: { kind: "enquiry", label: "Ask about parking & maintenance", labelKey: "faqs.cta_amen4", subject: "FAQ · Parking" },
  },
  ...
  // ---------- Legal, RERA & Possession ----------
  {
    ...
    cta: { kind: "enquiry", label: "Get the RERA status", labelKey: "faqs.cta_legal1", subject: "FAQ · RERA" },
  },
  {
    category: "legal",
    qKey: "faqs.q_legal2",
    ...
    cta: { kind: "enquiry", label: "Get a possession update", labelKey: "faqs.cta_legal2", subject: "FAQ · Possession" },
  },
  {
    category: "legal",
    qKey: "faqs.q_legal3",
  ...
  // ---------- Buying Process & NRI ----------
  {
    ...
    cta: { kind: "enquiry", label: "Speak to the client team", labelKey: "faqs.cta_buy1", subject: "FAQ · Booking" },
  },
  {
    category: "buying",
    qKey: "faqs.q_buy2",
  ...
  },
  {
    ...
    cta: { kind: "enquiry", label: "Arrange an NRI consultation", labelKey: "faqs.cta_buy3", subject: "FAQ · NRI" },
  },
  {
    category: "buying",
    qKey: "faqs.q_buy4",
...
export default function FaqsPage() {
  ...
  return (
    <div ref={root} className="bg-canvas">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
          <div>
            <p className="rise max-w-[52ch] leading-relaxed text-ink-soft">
              ...
              >
                {t("faqs.officialListingA")} {PROJECT.developer} {t("faqs.officialListingB")}
              </a>{" "}
              {t("faqs.sourcedB")} {PROJECT.name}{t("faqs.sourcedC")}
            </p>
            <p className="rise mt-4 max-w-[52ch] leading-relaxed text-ink-soft">
              {t("faqs.deliberateA")}{" "}
              {GATED.length} {t("faqs.deliberateB")}
            </p>
            <p className="rise mt-4 max-w-[52ch] leading-relaxed text-ink-soft">
              {t("faqs.headlineA")}{" "}
              {BANK.length} {t("faqs.headlineB")}
            </p>
          </div>

          <div className="jump self-start rounded-[1.25rem] border border-line bg-paper p-7 md:p-8">
            <p className="mono text-[0.6rem] tracking-[0.22em] text-ink-faint">{t("faqs.jumpTo")}</p>
                    ...
                    >
                      <div className="overflow-hidden">
                        <div className="pb-7 pr-8 lg:pl-0">
                          <p className="max-w-[68ch] leading-relaxed text-ink-soft">{t(item.aKey)}</p>
                          {item.cta && (
                            <button
                              type="button"
      ...
      <section className="container-lux pb-[clamp(4rem,11vh,7rem)]">
        ...
        <div className="mt-12 flex flex-wrap items-center gap-6 border-t border-line pt-8">
          ...
          <a
            ...
            aria-label={`${t("faqs.callAriaA")} ${PROJECT.name} ${t("faqs.callAriaB")} ${PROJECT.phone}`}
          >
      ...
      <CtaBand title={t("faqs.ctaTitle")} accent={t("faqs.ctaAccent")} subject="FAQs" />
    </div>
  );
}
