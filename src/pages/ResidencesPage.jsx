  ...
  return (
    <div ref={root}>
      <Seo
        ...
        description="M3M Brabus 4 BHK (approx. 5,000 sq.ft) and 5 BHK (approx. 7,000 sq.ft) branded residences — layouts, orientation, Italian marble, VRV climate control and the full specification schedule."
        path="/residences"
