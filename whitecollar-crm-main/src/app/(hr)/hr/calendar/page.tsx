...
// Each `day` is a UTC instant = 00:00 IST; add exactly 24h to step IST days (IST
// has no DST). Labels are formatted in IST so the date shown matches the bucket.
...
export default async function CalendarPage() {
  ...
  const today = istDayRange().start; // 00:00 IST today (audit #8/#27)
