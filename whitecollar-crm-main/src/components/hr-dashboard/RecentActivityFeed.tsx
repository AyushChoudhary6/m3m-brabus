  ...
  return (
    ...
    >
      ...
      {rows.length === 0 ? (
        ...
        // Height-capped scroll region so this card sits level with the
        // Recruitment Funnel (≈9 stages) instead of stretching with the feed —
        // extra activity scrolls inside the card. `overscroll-contain` keeps the
        // wheel from bubbling to the page once the ends are reached.
