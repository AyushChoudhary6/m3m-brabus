...
import {
  ...
  ChevronLeft, ChevronRight, Gem, HelpCircle, AlertTriangle, Lock, PhoneCall, Briefcase, Database, ShieldCheck, Bot, Inbox, BadgeDollarSign, MapPin, Images, History, Search, Tag, KeyRound, Fingerprint, BookOpen, GraduationCap, Globe,
} from "lucide-react";
...
const fullNav: NavSection[] = [
  { section: "WORKSPACE", items: [
    ...
    // Brabus — read-only view of website leads from the M3M Brabus site
    // (pulled live from that site's Neon DB, also mirrored to Google Sheets).
    { href: "/brabus",      label: "Brabus",         Icon: Globe },
  ...
  { section: "ADMIN", adminOnly: true, items: [
    ...
    { href: "/admin/buyer-imports",   label: "Buyer Imports",      Icon: Upload },
